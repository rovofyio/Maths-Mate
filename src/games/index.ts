...
export const GAMES: GameMeta[] = [
  ...
  { id: "pvp", name: "Monster PvP", emoji: "⚔️", color: "#8e44ad", blurb: "Pokémon-style PvP: maths hits deal 5/2/0 DMG. Calculus, surds & fractions.", ages: [12, 18], free: true, tag: "Premium · PvP" },
  { id: "fractions", name: "Fraction Feast", emoji: "🍕", color: "#e17055", blurb: "Serve the pizza slice that matches the fraction.", ages: [8, 14], free: true, tag: "Premium" },
  { id: "runner", name: "Math Runner", emoji: "🏃", color: "#00cec9", blurb: "Dodge wrong answers on an endless run.", ages: [6, 18], free: true, tag: "Premium" },
  { id: "truefalse", name: "True or False", emoji: "⚖️", color: "#a29bfe", blurb: "Race the clock judging true or false statements.", ages: [7, 18], free: true, tag: "Free" },
];
